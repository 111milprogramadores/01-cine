...
public class HorarioFuncion {
    ...
    private Date horaPrimeraFuncion; //Controlar tipo de datos
    private Date horaUltimaFuncion;  //Controlar tipo de datos
    ...
    {
       return "El horario de la primera función es: "+  this.horaPrimeraFuncion + "El horario de la última función es: " + this.horaUltimaFuncion;
    }
